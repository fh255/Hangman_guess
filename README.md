...
| Exit and New Game     | During the game, choose to exit and start a new game.                                                                                                 | The game should exit or start a new game based on user input.                                                                                              | Pass         |
| Play Again            | After finishing a game, choose to play again or exit.                                                                                                 | The program should allow the player to continue or exit based on user input.                                                                               | Pass         |
